...
namespace AddressBookMultiThreading
{
    public class AddressBookRepository
    {
        ...
        /// <summary>
        /// Retrieve all the stored records in the address book service table by fetching all the records
        /// </summary>
        ...
        /// <summary>
        /// Get the detail of the record in the address book entered within a time frame
        /// </summary>
